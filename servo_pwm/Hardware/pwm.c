...
void pwm_init(void)
{
	...
	tim_time_base_init.TIM_Period = 20000 - 1;  // ARR 自动重装寄存器值
	tim_time_base_init.TIM_Prescaler = 72 - 1;  // PSC
	...
	TIM_OC1Init(TIM2, &tim_oc_init);  // 初始化通道1
	TIM_OC2Init(TIM2, &tim_oc_init);  // 初始化通道2
